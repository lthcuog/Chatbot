...
function setUserResponse(val) {
	...
	var UserResponse = '<img class="userAvatar" src=' + "./static/img/botImg.jpeg" + '><p class="userMsg">' + val + ' </p><div class="clearfix"></div>';
...
function setBotResponse(val) {
	setTimeout(function () {
		if (val.length < 1) {
			...
			var BotResponse = '<img class="botAvatar" src="./static/img/dohieu.jpg"><p class="botMsg">' + msg + '</p><div class="clearfix"></div>';
